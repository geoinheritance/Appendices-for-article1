...
#Assessed the Collinearity of PPVs in the data frame by viewing the correlation coefficient of each #pair of the predictor variables using pairwise correlation
